...
export const projects: Project[] = [
  ...
  {
    id: 9,
    title: "Boardroom Football Club",
    description: "The ultimate AI-powered soccer simulation experience.",
    status: "completed",
    images: ["/images/project9-1.jpg", "/images/project9-2.jpg"],
    content: "Football manager has long been one of my favorite games, but I and much of the community have been very frustrated with the lack of innovation in the genre. That is why I have built Boardroom Football Club, a soccer simulation game that is powered by AI. Using these new technologies I can generate NPCs that feel dramatically more realisitc, making this game that is heavily text and interaction based feel much more realistic and engaging. This is a very ambitious project, but one that I am hoping to kickstart the community into continuing building with the alpha version I create this week.",
    liveLink: "https://boardroomfc.com",
  },
  {
    id: 10,
    title: "????",
